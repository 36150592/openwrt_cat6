#!/bin/sh
EXTPATH=/mnt/openwrt_cat6/
LIBPATH=toolchain-mipsel_1004kc+dsp_gcc-4.8-linaro_uClibc-0.9.33.2
export PATH=$PATH:$EXTPATH/staging_dir/host/bin:$EXTPATH/staging_dir/$LIBPATH/bin
