 ...
 */
#define VP_OPTION_DEFAULT_DEBUG_SELECT (VP_DBG_ERROR | VP_DBG_WARNING)// | VP_DBG_INFO | VP_DBG_HAL | VP_DBG_EVENT | VP_DBG_LINE_STATE | VP_DBG_HOOK | VP_DBG_CALIBRATION)
...
#define VP_CC_886_SERIES		// by lizd  
