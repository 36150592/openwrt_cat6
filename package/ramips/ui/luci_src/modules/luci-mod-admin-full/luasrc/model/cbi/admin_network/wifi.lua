...
--	ch = s:taboption("general", ListValue, "channel", translate("Channel"))
	...
	ch:value("36","5.180 GHz (Channel 36)")
        ch:value("40","5.200 GHz (Channel 40)")
        ch:value("44","5.220 GHz (Channel 44)")
        ch:value("48","5.240 GHz (Channel 48)")
        ch:value("52","5.260 GHz (Channel 52)")
        ch:value("56","5.280 GHz (Channel 56)")
        ch:value("60","5.300 GHz (Channel 60)")
        ch:value("64","5.320 GHz (Channel 64)")
	ch:value("149","5.745 GHz (Channel 149)")
        ch:value("153","5.765 GHz (Channel 153)")
        ch:value("157","5.785 GHz (Channel 157)")
        ch:value("161","5.805 GHz (Channel 161)")
        ch:value("165","5.825 GHz (Channel 165)")
end
...
if hwtype == "rt2860v2" or hwtype == "mt7603e"  or hwtype ==  "mt7612e"  or value == "mt7610"  then
	tp = s:taboption("general",
		(#tx_power_list > 0) and ListValue or Value,
...
elseif hwtype == "rt2860v2" or hwtype == "mt7603e" or hwtype ==  "mt7612e"  or value == "mt7610"  then
	encr:value("psk", "WPA-PSK")
	encr:value("psk2", "WPA2-PSK")
	encr:value("psk+psk2", "WPA-PSK/WPA2-PSK Mixed Mode")
end
